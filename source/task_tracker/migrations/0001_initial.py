    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_name', models.CharField(max_length=40, verbose_name='название статуса')),
            ],
        ),
        migrations.CreateModel(
            name='Type',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_name', models.CharField(max_length=40, verbose_name='название типа')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('types', models.ManyToManyField(blank=True, related_name='types', to='task_tracker.type')),
            ],
        ),
    ]
